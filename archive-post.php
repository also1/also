...
<html data-wf-page="5da199e75ac6b0cdb519be16" data-wf-site="5d9c423459eb471dbcd49727">
...
';
  if($menu_items[$key+1]->menu_item_parent == 0 && $menu_items[$key]->menu_item_parent != 0){
    ...
    <div class="header_box">
      <div class="blog_main_title">Блог</div>
    </div>
  </div>
  <div class="content_section">
    <div class="cont">
      <div><?php if(have_posts()) : while(have_posts()) : the_post(); ?><div class="post_box">
          ...
          <div class="post_details">
            ...
            <a href="#"><?= get_the_date(get_option('date_format')); ?></a>/
            <?php  $categories = get_the_category($post->ID); foreach($categories as $category) { ?><a href="<?= get_category_link($category->cat_ID) ?>"><?= $category->cat_name ?></a><?php if($category != end($categories)) echo ", "; } ?>
          </div>
          <h1 class="h1"><?php the_title(); ?></h1>
          <div class="post_content w-richtext"><?php the_excerpt(); ?></div>
          <a href="<?php the_permalink(); ?>" class="btn back w-button">Читать далее</a>
